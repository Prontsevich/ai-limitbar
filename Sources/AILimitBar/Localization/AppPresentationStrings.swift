...
extension AppStrings {
    enum Common {
        ...
        static let delete = AppString("common.action.delete", defaultValue: "Delete", comment: "Delete button")
    ...
    enum Storage {
        ...
        static let openRouterCredentials = AppString("storage.openrouter_credentials", defaultValue: "OpenRouter credential metadata could not be loaded.", comment: "OpenRouter credential metadata storage warning")
    }
...
extension AppStrings.Settings {
        ...
        enum Accounts {
            ...
            static let deleteTitle = AppString("settings.accounts.delete_title", defaultValue: "Delete Account?", comment: "Delete account alert title")
            ...
            static let deleteOpenRouterMessage = AppString("settings.accounts.delete_openrouter_message", defaultValue: "This securely deletes %@, every stored OpenRouter credential for it, and its capacity data from AI Limitbar.", comment: "Delete OpenRouter account alert message")
            ...
            static let deleteSelectedAccount = AppString("settings.accounts.delete_selected", defaultValue: "Delete selected account", comment: "Delete selected account tooltip and accessibility label")
...
extension AppStrings {
    ...
    enum OpenRouter {
        ...
        static let remainingOf = AppString("openrouter.value.remaining_of", defaultValue: "%@ remaining of %@", comment: "OpenRouter remaining and limit value")
        static let remaining = AppString("openrouter.value.remaining", defaultValue: "%@ remaining", comment: "OpenRouter remaining value")
        ...
        static let creditSummary = AppString("openrouter.value.credit_summary", defaultValue: "%@ remaining · %@ used · %@ total", comment: "OpenRouter account credits summary")
        ...
        static let authenticationFailed = AppString("openrouter.status.authentication_failed", defaultValue: "Credential authentication failed", comment: "OpenRouter authentication diagnostic")
        static let privilegeInsufficient = AppString("openrouter.status.privilege_insufficient", defaultValue: "Credential privileges are insufficient", comment: "OpenRouter insufficient privilege diagnostic")
        ...
        static let credentialUnavailable = AppString("openrouter.status.credential_unavailable", defaultValue: "Credential unavailable", comment: "OpenRouter unavailable credential diagnostic")
        static let noOrdinaryKeys = AppString("openrouter.no_ordinary_keys", defaultValue: "Add at least one ordinary API key to load per-key capacity.", comment: "OpenRouter no ordinary credentials message")
        static let managementUnavailable = AppString("openrouter.management_unavailable", defaultValue: "Shared credits are unavailable until an optional management credential is configured and refreshed.", comment: "OpenRouter unavailable shared credits message")
        ...
        static let credentialsTitle = AppString("openrouter.settings.credentials_title", defaultValue: "ORDINARY API KEYS", comment: "OpenRouter ordinary credentials Settings fieldset title")
        ...
        static let addKey = AppString("openrouter.settings.add_key", defaultValue: "Add API Key", comment: "Add OpenRouter ordinary key action")
        static let addManagement = AppString("openrouter.settings.add_management", defaultValue: "Add Management Credential", comment: "Add OpenRouter management credential action")
        static let rename = AppString("openrouter.settings.rename", defaultValue: "Rename", comment: "Rename OpenRouter key action")
        static let replace = AppString("openrouter.settings.replace", defaultValue: "Replace Credential", comment: "Replace OpenRouter credential action")
        static let recover = AppString("openrouter.settings.recover", defaultValue: "Recover Credential", comment: "Recover OpenRouter credential action")
        ...
        static let managementCredential = AppString("openrouter.settings.management_credential", defaultValue: "Management credential", comment: "OpenRouter management credential local label")
        static let storedSecurely = AppString("openrouter.settings.stored_securely", defaultValue: "Stored credentials stay in the macOS Data Protection Keychain and are never shown again.", comment: "OpenRouter credential storage disclosure")
        static let managementDisclosure = AppString("openrouter.settings.management_disclosure", defaultValue: "Optional elevated credential. AI Limitbar uses it only to read shared account credits through /api/v1/credits. It is never used as an ordinary-key fallback.", comment: "OpenRouter elevated credential disclosure")
        static let ordinaryDisclosure = AppString("openrouter.settings.ordinary_disclosure", defaultValue: "Each locally named ordinary key is refreshed independently through /api/v1/key.", comment: "OpenRouter ordinary credential disclosure")
        static let deleteCredentialTitle = AppString("openrouter.settings.delete_title", defaultValue: "Remove Credential?", comment: "OpenRouter credential delete confirmation title")
        static let deleteCredentialMessage = AppString("openrouter.settings.delete_message", defaultValue: "This securely deletes %@ from Keychain and removes its local capacity context.", comment: "OpenRouter credential delete confirmation message")
        static let addKeyTitle = AppString("openrouter.editor.add_key_title", defaultValue: "Add Ordinary API Key", comment: "OpenRouter ordinary credential editor title")
        static let addManagementTitle = AppString("openrouter.editor.add_management_title", defaultValue: "Add Management Credential", comment: "OpenRouter management credential editor title")
        ...
        static let replaceCredentialTitle = AppString("openrouter.editor.replace_title", defaultValue: "Replace Credential", comment: "OpenRouter credential replacement editor title")
        static let recoverCredentialTitle = AppString("openrouter.editor.recover_title", defaultValue: "Recover Credential", comment: "OpenRouter credential recovery editor title")
        static let keyName = AppString("openrouter.editor.key_name", defaultValue: "Local Key Name", comment: "OpenRouter local key name field")
        static let credential = AppString("openrouter.editor.credential", defaultValue: "Credential", comment: "OpenRouter credential secure field")
        static let credentialPlaceholder = AppString("openrouter.editor.credential_placeholder", defaultValue: "Paste credential", comment: "OpenRouter credential secure field placeholder")
        static let saveWithoutReadback = AppString("openrouter.editor.no_readback", defaultValue: "The entered value is written directly to Keychain. AI Limitbar will not display the stored value after this sheet closes.", comment: "OpenRouter no credential read-back notice")
        static let errorTitle = AppString("openrouter.error.title", defaultValue: "OpenRouter Credential Error", comment: "OpenRouter credential error alert title")
        ...
        static let emptyCredentialError = AppString("openrouter.error.empty_credential", defaultValue: "Enter a credential value.", comment: "OpenRouter empty credential error")
        static let managementExistsError = AppString("openrouter.error.management_exists", defaultValue: "This account already has a management credential.", comment: "OpenRouter duplicate management credential error")
        static let pendingDeletionError = AppString("openrouter.error.pending_deletion", defaultValue: "Secure deletion is pending. Retry removal before replacing this credential.", comment: "OpenRouter pending credential deletion error")
        static let unavailableCredentialError = AppString("openrouter.error.credential_unavailable", defaultValue: "The selected credential is unavailable. Reload Settings and try again.", comment: "OpenRouter missing credential error")
        static let keychainError = AppString("openrouter.error.keychain", defaultValue: "Keychain access failed. No stored credential was displayed.", comment: "OpenRouter Keychain error")
        static let storageError = AppString("openrouter.error.storage", defaultValue: "OpenRouter credential settings could not be saved.", comment: "OpenRouter storage error")
        static let sourceDescription = AppString("openrouter.settings.source_description", defaultValue: "Save the account, then add one or more ordinary API keys. Shared credits require a separate optional management credential.", comment: "OpenRouter account editor source description")
    }
